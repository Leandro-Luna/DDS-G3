...
import  MarketingPropiedad  from './marketingPropiedad'
...
const MenuEmpMarketing = () => {
    return (
        ...
        <div className='propiedades'>
                  ...
                  return(
                      < MarketingPropiedad key={index} imagen={item.imagen} nombre={item.nombre} estado={item.estado} precio={item.precio}/>
                  )
                              })}
 ...
 export default MenuEmpMarketing