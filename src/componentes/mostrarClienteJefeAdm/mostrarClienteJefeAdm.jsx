    ...
    return (
      <div className='login_container'>
          <div className='ver-cliente-cuadro'>
            ...
            <Link to='/ArchivoClientes'><button className='btn-volverEntradaSalida'> Volver atrás </button></Link>
      </div>
    )
  }
  
  export default MostrarClienteJefeAdm