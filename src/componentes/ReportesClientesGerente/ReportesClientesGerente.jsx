...
import './ReportesClientesGerente.css'

const ReportesClientesGerente = () => {
    return (
        ...
        <div className='solicitud-cita-caj-cuadro-gerente'>
            <div className='solicitud-cita-caj-cuadro-titulo1-gerente'>
                <h1>Reportes de clientes realizados entre 99/99/9999 y 99/99/9999</h1>
            </div>
            <div className='solicitud-cita-caj-cuadro-datos-gerente'>
                <table className='solicitud-cita-caj-tabla-gerente'>
                    ...
                    <tr>
                        ...
                        <td>9999999999</td>
                        <td>99/99/9999</td>
                        <td><a href="files\ReporteClientes.pdf" download="ReporteClientes" className='boton-volver-Reportes-PDF-gerente'>PDF</a></td>
                    </tr>
                    <tr>
                        <td>xxxxxxxxx</td>
                        <td>9999999999</td>
  ...
  export default ReportesClientesGerente