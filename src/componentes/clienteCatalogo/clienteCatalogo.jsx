...
import  ClientePropiedad  from '../clientePropiedad/clientePropiedad'
    ...
    return (
      ...
      <div className='fondo'>
          ...
          <div className='propiedades'>
                    ...
                    return(
                        < ClientePropiedad key={index} imagen={item.imagen} nombre={item.nombre} estado={item.estado} precio={item.precio}/>
                    )
                                })}
